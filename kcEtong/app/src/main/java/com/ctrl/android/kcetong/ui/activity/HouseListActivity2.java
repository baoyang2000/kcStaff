...
import com.ctrl.android.kcetong.ui.adapter.HouseListAdapter2;
...
public class HouseListActivity2 extends BaseActivity {
    ...
    protected void initData() {
        ...
        list = new ArrayList<>();
        adapter = new HouseListAdapter2(this, new HouseListAdapter2.HouseBindListener() {
            @Override
        ...
        listView.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                if (parentRowCountPerPage == 5) {
                    RecyclerViewStateUtils.setFooterViewState(HouseListActivity2.this, listView, 5, LoadingFooter.State.Loading, null);
                    houseList();
                } else {
                    RecyclerViewStateUtils.setFooterViewState(HouseListActivity2.this, listView, 10, LoadingFooter.State.Normal, null);
                }
            }
        });
    ...
    private void houseList() {
        ...
        RetrofitUtil.Api().requestHouseList(map).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new BaseTSubscriber<HouseResult>(this) {
            @Override
            ...
            @Override
            public void onNext(HouseResult houseBean) {
        ...
        RetrofitUtil.Api().setHouseBind(map).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new BaseTSubscriber<ResponseBody>(this) {
            ...
            public void onResponseCallback(JSONObject response, String resultCode) {
                ...
                if (TextUtils.equals(resultCode, ConstantsData.success)) {
                    ...
                    try {
                        MessageUtils.showShortToast(HouseListActivity2.this, response.getString("description"));
