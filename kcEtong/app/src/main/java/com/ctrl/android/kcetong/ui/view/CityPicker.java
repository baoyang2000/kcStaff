...
import com.ctrl.android.kcetong.model.Cityinfo;
import com.ctrl.android.kcetong.toolkit.util.CitycodeUtil;
...
public class CityPicker extends LinearLayout {
    ...
    public String getCity_Name() {
        String str = cityPicker.getSelectedText();
        return str;
    }
    public String getCouny_Name() {
        String str = counyPicker.getSelectedText();
        return str;
    }
