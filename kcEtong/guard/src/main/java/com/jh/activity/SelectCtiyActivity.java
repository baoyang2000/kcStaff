...
import com.jh.R;
import com.jh.adapter.CityAdapter;
import com.jh.adapter.SearchCityAdapter;
import com.jh.bean.City;
import com.jh.db.CityDao;
import com.jh.view.BladeView;
import com.jh.view.PinnedHeaderListView;
...
public class SelectCtiyActivity extends AppCompatActivity implements TextWatcher,
    ...
    private void initView() {
        iv_select_city_back = (ImageView) findViewById(R.id.iv_select_city_back);
        iv_select_city_back.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        }else if(i == R.id.iv_select_city_back){
