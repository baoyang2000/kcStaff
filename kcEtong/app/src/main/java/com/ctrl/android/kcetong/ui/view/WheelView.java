...
public class WheelView extends View {
    ...
    private static final int VALUE_TEXT_COLOR = 0xF0266dbc;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0x88C0C0C0);
        }

        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(com.ctrl.android.kcetong.R.drawable.wheel_val);
        }
