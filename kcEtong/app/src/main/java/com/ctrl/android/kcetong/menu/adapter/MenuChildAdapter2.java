...
public class MenuChildAdapter2 extends BaseAdapter {
	private List<MenuEntity> menuList;
	private Context          context;
	private boolean IsEdit = false;

	public MenuChildAdapter2(Context context, List<MenuEntity> list, boolean isEdit2) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHodler.deleteImg.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!menuEntity.isSelect()) {
					MenuManageActivity2.AddMenu(menuEntity);
				}
			}
		});
